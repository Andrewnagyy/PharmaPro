...
namespace PharmaPro.DS.Migrations
{
    ...
    [Migration("20240510145303_removeProductImages1")]
    partial class removeProductImages1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaPro.Domain.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PharmaPro.Domain.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PharmaPro.Domain.VisaClass.Visa", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PharmaPro.Domain.Orders.OrderItem", b =>
                {
                    b.HasOne("PharmaPro.Domain.Orders.Order", null)
                        .WithMany("OrderItems")
